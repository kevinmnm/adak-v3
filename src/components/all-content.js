let all_content = [
  {
    ...
    description:
      "There are some important boolean behaviors to be aware of in JavaScript. Let's look at some coercive comparison and see what outputs true or false.",
    referenceLink1: "",
    referenceLink2: "",
  ...
  },
  {
    ...
    description:
      'JavaScript offers 3 different mouse events: (e.pageX & e.pageY), (e.clientX & e.clientY), (e.offsetX, e.offsetY). The "page" gets mouse position relative to the whole page. The "client" get mouse position relative to the current viewport. The "offset" gets mouse position relative to (inside of) the current element.',
    referenceLink1:
  ...
  },
  {
    ...
    description:
      "There are many ways to write same function syntax. With arrow function, you can write less code and do the same work. It it a good idea to review arrow syntax for future learning as not all documentation is written in traditional syntax.",
  ...
  },
  {
    ...
    description:
      "filter() is a method to filter out certain value from array. You can filter directly from the array (example below) or create a separate reusable function (refer to reference link).",
    referenceLink1:
  ...
  },
  {
    ...
    description:
      "Vue props quick and simple example. Props can be used to render different values within components. It is important to follow correct syntax to avoid any erros, which can be very annoying. Below example shows how props can be used to render different value in loops.",
  ...
  },
  {
    ...
    description:
      "Using push() method, object (JSON form) can be pushed into array.",
    referenceLink1:
  ...
  },
  {
    ...
    topic: "Key Modifiers",
    description:
      "Vue offers key modifiers to easily bind keyboard shorcut with functions.",
  ...
  },
  {
    ...
    topic: "Async Await",
    description:
      "How to use async await method! Very important not only to use it for ajax request, but also for many different functions that needs to be executed in order!",
  ...
  },
  {
    ...
    description:
      "Random color picking funciton and responsive design created with JavaScript. This will be a good reference for future projects.",
    referenceLink1:
  ...
  },
  {
    ...
    topic: "Slot",
    description:
      'Slot "<slot></slot>" can be declared in compoent template if you want to use custom component like regular HTML. See example code below for further clarification.',
    referenceLink1:
  ...
  },
  {
    ...
    description:
      '"is" attribute is a new HTML attribute implemented in 2020. This attribute is used in the Custom Element specification.',
    referenceLink1:
      "https://stackoverflow.com/questions/27434431/what-is-html-is-attribute#:~:text=In%202020%3A,documented%20for%20developers%20at%20mdn.",
    referenceLink2:
      "https://www.w3.org/TR/2016/WD-custom-elements-20161013/#attr-is",
  ...
  },
  {
    ...
    description:
      "CSS calc() is a very useful function when creating responsive website design. This flexible function will help reduce size of JavaScript file to maintain the site responsive",
  ...
  },
  {
    ...
    description:
      "After destroying component or instance, web memory will be erased and reset the previous status of the element. <keep-alive> can come in handy when you want to archive the element's status. \n\nNote: This is not localStorage.",
    referenceLink1: "",
    referenceLink2: "",
  ...
  },
  {
    ...
    description:
      "Sometimes Vue forces functions to work little differently from JavaScript. Async Await is one of them. This learning content will provide good examples of how I should write async await function in Vue especially within component with props implementation.",
    referenceLink1: "https://javascript.info/async-await",
    referenceLink2:
      "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Statements/async_function",
  ...
  },
  {
    ...
    description:
      "PLEASE LOOK OVER THIS CONTENT MULTIPLE TIME TO GET COMFORTABLE. This content took whole day for me write. Complicated Vue component usage was utilized. Some JavaScript arry iterations are noted as well.",
  ...
  },
  {
    ...
    description:
      "Dynamic arugument is a way to bind HTML property as needed. Documentation below will provide clear explanation.",
  ...
  },
  {
    ...
    description:
      "Very simple shortcut function (multiple keys) demonstrated with JS.",
  ...
  },
  {
    ...
    topic: "Classes",
    description:
      "Class is an important method in JavaScript especially for advanced level developers. Class is syntax sugar for _prototype_.",
  ...
  },
  {
    ...
    description:
      "When having long list of array, rest parameter will come in very handy.",
  ...
  },
  {
    ...
    description:
      "This animation content reviews transform, tranform-origin, :before, :after, scale, and rotate.",
  ...
  },
  {
    ...
    description:
      "Let's review on JS return behavior especially with setInterval or setTimeout.",
    referenceLink1:
  ...
  },
  {
    ...
    description:
      "Debouncing is an effective method to prevent events to repeat multiple times especially with queued calls.",
    referenceLink1:
      "https://www.w3schools.com/code/tryit.asp?filename=GHIXM13TJSVY",
  ...
  },
  {
    ...
    description:
      "New for loop methods introduced in ES6: [for in] and [for of]. [for in] returns enumerable properties. [for of] returns iterable properties.",
  ...
  },
  {
    ...
    description:
      "There's an effective way to save props passed from parent to child's data. However, this methods is NOT reactive! However, you ca fix it with computed data.",
    referenceLink1:
      "https://www.w3schools.com/code/tryit.asp?filename=GHNCA53X63A0",
  ...
  },
  {
    ...
    description:
      'Vue helper function "this" breaks if not following specific syntax.',
    referenceLink1: "",
    referenceLink2: "",
  ...
  },
  {
    ...
    description:
      "Vue CLI will auto generate boiler plate, but it's important to understand connections between files for smooth coding experience. Quick overview below that includes Vue Router.",
  ...
  },
  {
    ...
    description:
      "Params in Vue routing offers further reduction in refreshing content by detecting params change and only re-rendering necessary content instead of reloading whole component. See simple exmaple from github from link below.",
    referenceLink1:
      "https://router.vuejs.org/guide/essentials/dynamic-matching.html",
    referenceLink2:
      "https://github.com/kevinmnm/dynamic_route_match_simple.git",
  ...
  },
  {
    ...
    description:
      "Vue has watch properties that can be declared as an object to alter its defaul behavior. This can be very useful especially to avoid declaring same function in mounted() and watch().",
  ...
  },
  {
    ...
    description:
      "Quick note on chaining Firebase methods to simultaneously create credentials and preferred display name.",
    referenceLink1:
  ...
  },
  {
    ...
    description:
      "Important overview of combining Vue Router with Firebase. Plus method of sending verification email upon signup and Route Guarding depending on if user is logged in or not.",
  ...
  },
  {
    ...
    description:
      "Some setup to keep in mind when integrating Vue CLI with Github Pages.",
  ...
  },
  {
    ...
    description:
      "Must add .htaccess file in the root folder when using Vue Router History mode!",
    referenceLink1:
  ...
  },
  {
    ...
    referenceLink2:
      "https://jaredmcateer.com/2017/09/significance-of-the-underscore-parameter-in-arrow-functions/",
  ...
  },
  {
    ...
    description:
      "Using data attribute can help manage elements with unique values.",
  ...
  },
  {
    ...
    description:
      "Some aspects in Vuex is worth to just memorize rather than Googling each time.",
    referenceLink1:
  ...
  },
  {
    ...
    description:
      "Learning basics before scrutinizing ES6 Destructuring for objects.",
    referenceLink1:
      "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators/Destructuring_assignment",
    referenceLink2:
      "https://www.youtube.com/watch?v=-vR3a11Wzt0&ab_channel=freeCodeCamp.org",
  ...
  },
  {
    ...
    description:
      "This should be a default method when declaring component in React as this is the only way to apply functions to make the component stateless.",
  ...
  },
  {
    ...
    description:
      "Important syntax to remember when declaring component with function.",
    referenceLink1: "https://reactjs.org/docs/hooks-state.html",
    referenceLink2:
      "https://www.udemy.com/course/react-the-complete-guide-incl-redux/learn/lecture/13556164#content",
  ...
  },
  {
    ...
    description:
      "A way I figured out to preserve previous state and update specific value of state.",
    referenceLink1: "https://reactjs.org/docs/state-and-lifecycle.html",
  ...
  },
  {
    ...
    description:
      "Passing function as a props down to child component quick note.",
    referenceLink1: "",
    referenceLink2: "",
  ...
  },
  {
    ...
    description:
      "React two-way data binding is simpler than Vue's emit method.",
    referenceLink1: "",
    referenceLink2: "",
  ...
  },
  {
    ...
    referenceLink2:
      "https://stackoverflow.com/questions/39241046/deepcopy-in-react#:~:text=5%20Answers&text=You%20can%20use%20JSON.,you%20want%20to%20deeply%20copy.",
  ...
  },
  {
    ...
    description:
      'React Lifecycles are only available in class-based components. Use "useEffect()" instead in functional-based components.',
    referenceLink1:
  ...
  },
  {
    ...
    referenceLink1:
      "https://www.udemy.com/course/react-the-complete-guide-incl-redux/learn/lecture/13556268#overview",
    referenceLink2:
  ...
  },
  {
    ...
    referenceLink1:
      "https://www.udemy.com/course/react-the-complete-guide-incl-redux/learn/lecture/13585862#overview",
    referenceLink2: "https://reactjs.org/docs/state-and-lifecycle.html",
  ...
  },
  {
    ...
    description:
      "useEffect() is a lifecycle hook for functional components in React. It's bascially a combination of componentDidMount() and componentDidUpdate() in class based components. Therefore, useEffect() will trigger everytime state or props updates.",
    referenceLink1:
      "https://www.udemy.com/course/react-the-complete-guide-incl-redux/learn/lecture/13556284#content",
  ...
  },
  {
    ...
    referenceLink1:
      "https://www.udemy.com/course/react-the-complete-guide-incl-redux/learn/lecture/13556338#content",
  ...
  },
  {
    ...
    referenceLink1:
      "https://www.udemy.com/course/react-the-complete-guide-incl-redux/learn/lecture/13556340#content",
    referenceLink2: "https://reactjs.org/docs/refs-and-the-dom.html",
  ...
  },
  {
    ...
    topic: "createContext",
    description:
      'Similar concept as Vuex. React state is used to circumvent props passing down to "nested" child components.',
    referenceLink1:
      "https://www.udemy.com/course/react-the-complete-guide-incl-redux/learn/lecture/13556344#content",
  ...
  },
  {
    ...
    description:
      "This will be in-use a lot more than traditional context setup method.",
    referenceLink1:
      "https://www.udemy.com/course/react-the-complete-guide-incl-redux/learn/lecture/13556346#content",
  ...
  },
  {
    ...
    description:
      "Vue has built-in method $emit. Same approach can be different in React.",
    referenceLink1:
  ...
  },
  {
    ...
    topic: "Lazy Loading",
    description:
      "Remeber the basic syntax: <Router> => <Suspense> => <Switch> => <Route>",
    referenceLink1:
      "https://www.udemy.com/course/react-the-complete-guide-incl-redux/learn/lecture/12296826#content",
  ...
  },
  {
    ...
    referenceLink1:
      "https://www.udemy.com/course/react-the-complete-guide-incl-redux/learn/lecture/8226862#content",
    referenceLink2:
  ...
  },
  {
    ...
    description:
      "Quick overview of dispatching input value using Redux for class component.",
    referenceLink1: "",
    referenceLink2: "",
  ...
  },
  {
    ...
    description:
      "Quick documentation reference. Visit links to view in detail.",
    referenceLink1:
  ...
  },
  {
    ...
    description:
      "Some Node.js basics to keep in mind. Always refer to official documentation.",
    referenceLink1: "https://nodejs.org/en/docs/",
    referenceLink2:
      "https://nodejs.org/dist/latest-v14.x/docs/api/https.html#https_https_get_url_options_callback",
  ...
  },
  {
    ...
    referenceLink2:
      "https://nodejs.org/docs/latest/api/process.html#process_process_argv0",
  ...
  },
  {
    ...
    topic: "Nodemon",
    description:
      "Nodemon is a developer tool to automate auto run development server.",
    referenceLink1: "",
    referenceLink2: "",
  ...
  },
  {
    ...
    topic: "body-parser",
    description:
      "body-parser is one of the eseential package to include in Express.js projects.",
    referenceLink1: "",
    referenceLink2: "",
  ...
  },
  {
    ...
    description:
      "A simple an quick way to implement 404/missing page in Express.js.",
    referenceLink1: "",
    referenceLink2: "",
  ...
  },
  {
    ...
    description:
      "Template engines are used in Node.js to reduce amount of HTML code. It can dynamically render certain HTML codes conditionally.",
    referenceLink1: "",
    referenceLink2: "",
